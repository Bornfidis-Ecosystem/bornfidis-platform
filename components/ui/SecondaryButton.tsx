...
const culinaryClass =
  'inline-flex min-h-[48px] items-center justify-center rounded-none border border-charcoal bg-transparent px-8 py-3 font-sans text-[12px] font-semibold uppercase tracking-[0.1em] text-charcoal shadow-none transition-colors duration-refined hover:border-gold hover:text-charcoal focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold'
