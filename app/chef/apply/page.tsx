...
export default function ChefApplyPage() {
  return (
    <div className="min-h-screen bg-white w-full overflow-x-hidden">
      {/* Header */}
      <header className="bg-forestDark text-white py-8 md:py-12 w-full">
      ...
      <main className="container mx-auto px-4 py-8 md:py-12 max-w-7xl w-full">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-forestDark mb-4">Chef Application</h2>
            <p className="text-gray-600 mb-4">
              We're looking for passionate chefs who share our values of faith, community, and regenerative practices.
            </p>
            <div className="bg-green-50 border-l-4 border-forestDark p-4 mb-6">
              <h3 className="font-semibold text-forestDark mb-2">What to Expect:</h3>
