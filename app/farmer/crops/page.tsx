...
/**
 * Phase 2G — Crop planning (declare crops and planting cycles). Placeholder.
 */
export default async function FarmerCropsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <h1 className="text-xl font-semibold text-gray-900">Crop Planning</h1>
      <p className="text-sm text-gray-500">
        Declare crops and planting cycles. This section will be expanded for ProJu and harvest planning.
      </p>
      <div className="rounded-lg border border-gray-200 bg-white p-6 text-center text-gray-500">
        Crop declaration coming soon.
      </div>
