  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="max-w-2xl w-full text-center">
        <div className="bg-gold text-forestDark py-12 rounded-lg shadow-lg">
          <div className="h-1 w-24 bg-forestDark mx-auto mb-6"></div>
          <h1 className="text-4xl font-bold mb-4">Thank You!</h1>
          <p className="text-forestDark text-lg mb-6">
            Your impact investment inquiry has been submitted successfully.
          </p>
          <p className="text-forestDarker text-sm mb-8">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Link
              href="/"
              className="inline-block px-6 py-3 bg-white text-forestDark rounded-lg font-semibold hover:bg-gray-100 transition"
            >
              Return to Home
            </Link>
          </div>
