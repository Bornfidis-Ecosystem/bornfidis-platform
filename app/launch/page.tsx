      ...
      <main className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="space-y-16">
          ...
          <section className="text-center">
            <h2 className="text-4xl font-bold text-forestDark mb-6">The Movement Begins</h2>
            <div className="max-w-3xl mx-auto text-lg text-gray-700 leading-relaxed space-y-4">
              ...
              <p className="font-semibold text-forestDark">
          ...
          {/* Call to Action Grid */}
          <section>
            <h2 className="text-3xl font-bold text-forestDark mb-8 text-center">Get Involved</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-forestDark">Host a faith-anchored meal</p>
              </Link>
              <Link
          ...
          <section className="bg-[#f0fdf4] p-8 rounded-lg border border-[#d1fae5]">
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-forestDark mb-1">Public Launch</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-forestDark mb-1">Community Building</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-forestDark mb-1">Regional Expansion</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-forestDark mb-1">Global Movement</h3>
