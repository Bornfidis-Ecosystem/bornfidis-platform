          ...
          <div className="flex flex-wrap gap-3">
            {!portalData.deposit.paid && hasQuote && quoteStatus !== 'declined' && (
              <button
                ...
                className="px-6 py-3 bg-forestDark text-white rounded-lg font-semibold hover:bg-forestDarker transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {isProcessingPayment ? (
                  <>
            ...
            {portalData.fully_paid && portalData.invoice_available && lineItems.length > 0 && (
              <PDFDownloadLink
                ...
                className="px-6 py-3 bg-gold text-forestDark rounded-lg font-semibold hover:bg-brass transition flex items-center gap-2"
              >
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 mb-6">
          ...
          <form onSubmit={handleSendMessage} className="space-y-4">
            ...
            <button
              ...
              className="px-6 py-2 bg-forestDark text-white rounded-lg font-semibold hover:bg-forestDarker transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
