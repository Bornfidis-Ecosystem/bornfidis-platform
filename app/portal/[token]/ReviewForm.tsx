    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          maxLength={2000}
          className="w-full px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-forestDark focus:border-transparent"
        />
      </div>
      ...
      <button
        type="submit"
        disabled={submitting}
        className="px-4 py-2 bg-forestDark text-white rounded font-medium hover:bg-forestDarker disabled:opacity-50"
      >
